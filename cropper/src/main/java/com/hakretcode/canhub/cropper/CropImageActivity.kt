...
import com.hakretcode.canhub.cropper.CropImageView.OnCropImageCompleteListener
import com.hakretcode.canhub.cropper.CropImageView.OnSetImageUriCompleteListener
import com.hakretcode.canhub.cropper.common.CommonVersionCheck
import com.hakretcode.canhub.cropper.databinding.CropImageActivityBinding
import com.hakretcode.canhub.cropper.utils.getUriForFile
import java.io.File
...
open class CropImageActivity :
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.let {
            ...
            it.setHomeAsUpIndicator(R.drawable.cropper_arrow_back)
        }
    }
